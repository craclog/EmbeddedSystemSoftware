...
public class PuzzleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = (EditText)findViewById(R.id.input_plainText);
        main_layout = (LinearLayout)findViewById(R.id.btn_main_LinearLayout);
        clock = (TextView)findViewById(R.id.time_textView);
        context = this;
